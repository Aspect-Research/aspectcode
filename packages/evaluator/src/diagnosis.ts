 ...
 */
export function buildDiagnosisPrompt(failures: ProbeResult[], agentsContent: string): string {
...
export function parseDiagnosisResponse(response: string, failureCount: number): Diagnosis {
  // Parse summary
